...
PRETRAINED_CHECKPOINT="/inspire/hdd/global_user/chaimingxu-240108540141/models/DiffusionVL-Qwen2.5VL-3B"
...
# IMAGE_FOLDER="/inspire/hdd/global_user/chaimingxu-240108540141/Diffusion/LaViDa/data/pretrain"
...
num_node=${1:-1}
gpu_num=${2:-2}
custom_run_name=${3:-"debug_20260426"}
...
CUDA_VISIBLE_DEVICES=0 python -m pdb llava/train/train_mem.py \
